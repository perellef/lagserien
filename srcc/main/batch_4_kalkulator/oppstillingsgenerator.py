...
class Oppstillingsgenerator:
    ...
    def generer(self):
        ...
        return self.unike_oppstillinger(self.__optimale_oppstillinger)
    ...
    def oppdater_optimal(self, oppstilling):
        optimal_lagoppstilling = OptimalLagoppstilling.fra(oppstilling)

        if oppstilling.poeng() > self.__poengterskel:
            self.__optimale_oppstillinger = [optimal_lagoppstilling]
            self.__poengterskel = oppstilling.poeng()
        else:
            self.__optimale_oppstillinger.append(optimal_lagoppstilling)
