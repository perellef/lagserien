...
defaultobjekter = {
    ...
    "Stevne": lambda x: None if x=='' else Stevne(stevne_id=AliasID.til_id(x), stevnedato=date.fromisoformat("9999-01-01"), stevnetittel="irrelevant", arena="irrelevant", sted=x, er_nasjonalt=False, rapportert=date.fromisoformat("9999-01-01"), er_innendørs=False),
