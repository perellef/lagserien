    ...
    def oppdater_cache(self, uttrekksdato):
        with self.__seriedata.connect() as peker:
            self.data = {
                ...
                "rangeringer": {
                    "utøvere": {
                        "mest-aktive-utøver": db_hent_rangering_mest_aktive_utøver(peker, self.__serieår, uttrekksdato),
                        "mest-avgjørende-utøver": db_hent_rangering_mest_avgjørende_utøver(peker, self.__serieår),
                    },
                    "lag": {
                        "mest-gjennomførte-lag": db_hent_rangering_mest_gjennomførte_lag(peker, self.__serieår),
                        "lag-med-størst-potensial": db_hent_rangering_lag_med_størst_potensial(peker, self.__serieår),
                        "lag-med-flest-juniorpoeng": db_hent_rangering_lag_med_flest_juniorpoeng(peker, self.__serieår, uttrekksdato)
                    },
                    "klubber": {
                        "klubb-med-størst-bredde": db_hent_rangering_klubb_med_størst_bredde(peker, self.__serieår, uttrekksdato),
                        "klubb-med-størst-forbedring": db_hent_rangering_klubb_med_største_forbedring(peker, self.__serieår, uttrekksdato),
                    },
                    "annet": {
                        "største-krets": db_hent_rangering_største_krets(peker, self.__serieår),
