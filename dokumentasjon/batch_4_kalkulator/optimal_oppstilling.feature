...
Scenario: Regel 1. Kalkulator setter opp oppstillingen med høyest seriepoeng av de som etterfølger oppstillingskravene.
    ...
    | ----------- | ----- | ------ | ------ | -------------- | ---------- | ---------- |
    | 1           | 800   | 100    | Per    | Ås kretsstevne | 11.00      | 2100.05.01 |
    | 2           | 700   | 200    | Per    | Ås kretsstevne | 23.00      | 2100.05.01 |
    | 3           | 600   | 400    | Tom    | Ås kretsstevne | 50.00      | 2100.05.01 |
    | 4           | 500   | 800    | Tom    | Ås kretsstevne | 2.00.00    | 2100.05.01 |
    | 5           | 400   | 60h    | Jan    | Ås kretsstevne | 8.00       | 2100.05.01 |
...
Scenario: Regel 2. Kalkulator ser på oppstillingene til de neste lagene for å velge blant flere gyldige oppstillinger med samme høyeste seriepoeng.
    ...
    | 1           | 800   | 100    | Per    | Ås kretsstevne | 11.00      | 2100.05.01 |
    | 2           | 700   | 200    | Per    | Ås kretsstevne | 23.00      | 2100.05.01 |
    | 3           | 600   | 400    | Ole    | Ås kretsstevne | 50.00      | 2100.05.01 |
    | 4           | 500   | 800    | Tom    | Ås kretsstevne | 2.00.00    | 2100.05.01 |
    | 5           | 500   | 800    | Jan    | Ås kretsstevne | 2.00.00    | 2100.05.01 |
    | 6           | 400   | 60h    | Tom    | Ås kretsstevne | 8.00       | 2100.05.01 |
    | ----------- | ----- | ------ | ------ | -------------- | ---------- | ---------- |
